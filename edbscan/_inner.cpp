...
static int __pyx_f_7edbscan_6_inner_pop(PyObject *, PyArrayObject *); /*proto*/
static int __pyx_f_7edbscan_6_inner_get_unlabeled(PyArrayObject *, PyArrayObject *, PyArrayObject *); /*proto*/
static bool __pyx_f_7edbscan_6_inner_value_in_array(int, std::vector<npy_intp> ); /*proto*/
static int __pyx_f_7edbscan_6_inner_get_max_0(PyArrayObject *); /*proto*/
static bool __pyx_f_7edbscan_6_inner_conflict(PyArrayObject *, PyArrayObject *); /*proto*/
...
static PyObject *__pyx_pf_7edbscan_6_inner_inner(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_is_core, PyArrayObject *__pyx_v_neighborhoods, PyArrayObject *__pyx_v_labels); /* proto */
...
static bool __pyx_f_7edbscan_6_inner_value_in_array(int __pyx_v_val, std::vector<npy_intp>  __pyx_v_arr) {
  ...
  bool __pyx_r;
  __Pyx_RefNannyDeclarations
  std::vector<npy_intp> ::iterator __pyx_t_1;
  npy_intp __pyx_t_2;
  int __pyx_t_3;
  __Pyx_RefNannySetupContext("value_in_array", 0);

  /* "edbscan/_inner.pyx":73
 *     cdef int i
 * 
 *     for i in arr:             # <<<<<<<<<<<<<<
 *         if i == val:
...
static PyMethodDef __pyx_methods[] = {
  {"inner", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_7edbscan_6_inner_1inner, METH_VARARGS|METH_KEYWORDS, __pyx_doc_7edbscan_6_inner_inner},
  {0, 0, 0, 0}
};
